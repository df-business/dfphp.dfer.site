...
console.log(url);
        ...
        uploadComplete: function(r){//富文本框图片上传        	
            var me = this;
            try{
                var json = eval('('+r+')');
        ...
        submit: function (callback) {
            ...
            var me = this,
                ...
                input = input[0];
console.log("ip_"+input);
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {

                if ( !this.parentNode ) {
                    return;
                }
	console.log(me);console.log(me.dialog);
                $('<iframe name="up"  style="display: none"></iframe>').insertBefore(me.dialog).on('load', function(){
                    var r = this.contentWindow.document.body.innerHTML;
                    //r="{'url':'upload/upfile_20171102034725.jpg','state':'SUCCESS',name:'',originalName:'',size:'',type:''}";
        			console.log(this);
