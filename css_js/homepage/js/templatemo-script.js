...
jQuery(function ($) {
    ...
    ---------------------------- */
    $(window).load(function () {     //所有内容加载完毕后触发

//      $("a, header, span ").css("font-family", "ft");

    });
   $(document).ready(function () {//表示文档结构已经加载完成（不包含图片等非文字媒体文件）,等价于“ $(document).ready(function () {”


        /* df
      -------------------------------------------*/
     
//      $("a, header, span ").css("font-family", "楷体");
        ...
        $('#slider').flexslider({
         ...
         ---------------------------------------------------------*/
                ...
                var defaultImgSrc = hash + "-img";
                
//              setInterval(function(){
                  
//                document.getElementById(defaultImgSrc).onload = function () {
//              l   console.log($(defaultImgSrc))
//	console.log($)
//                  $.backstretch($('#'+defaultImgSrc).attr('src'), { speed: 500 }); // show background image
//                }
//                },1000)
                  
               
//                document.getElementById(defaultImgSrc).onload = function () {
//              //    log(defaultImgSrc + " loaded")
//                  $.backstretch($(defaultImgSrc).attr('src'), { speed: 500 }); // show background image
//                }
