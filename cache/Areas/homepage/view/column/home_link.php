		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<div class="row form-horizontal form-group">
					<div class="col-sm-1">
						<a href='<?php echo SplitUrl(sprintf("homepage/column/%sadd",self::$db_hl)) ?>' class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>&nbsp;添加</a>
					</div>
				...
				<table class="table table-striped table-bordered table-hover dataTables-example">
					...
					<tbody>
						...
						<tr>
							...
							<td class='center'>
								<a href='<?php echo SplitUrl(sprintf("homepage/column/%sadd/{$v[0]}",self::$db_hl)) ?>'>[编辑]</a>
								<a href='<?php echo SplitUrl(sprintf("homepage/column/%sdel/{$v[0]}",self::$db_hl)) ?>' onclick='return confirm("您确认要删除吗?")'>[删除]</a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
