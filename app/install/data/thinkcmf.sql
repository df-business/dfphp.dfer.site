--
-- 表的结构 `dfer_admin_menu`
--

CREATE TABLE IF NOT EXISTS `dfer_admin_menu` (
...
--
-- 转存表中的数据 `dfer_admin_menu`
--

INSERT INTO `dfer_admin_menu` (`id`, `parent_id`, `type`, `status`, `list_order`, `app`, `controller`, `action`, `param`, `name`, `icon`, `remark`) VALUES
...
CREATE TABLE IF NOT EXISTS `dfer_asset` (
...
--
-- 表的结构 `dfer_auth_access`
--

CREATE TABLE IF NOT EXISTS `dfer_auth_access` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_auth_rule` (
...
--
-- 转存表中的数据 `dfer_auth_rule`
--

INSERT INTO `dfer_auth_rule` (`id`, `status`, `app`, `type`, `name`, `param`, `title`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `dfer_comment` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_hook` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dfer_hook` (`id`, `type`, `once`, `name`, `hook`, `app`, `description`) VALUES
...
--
-- 表的结构 `dfer_hook_plugin`
--

CREATE TABLE IF NOT EXISTS `dfer_hook_plugin` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
CREATE TABLE IF NOT EXISTS `dfer_link` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dfer_link` (`id`, `status`, `rating`, `list_order`, `description`, `url`, `name`, `image`, `target`, `rel`) VALUES
...
CREATE TABLE IF NOT EXISTS `dfer_nav` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dfer_nav` (`id`, `is_main`, `name`, `remark`) VALUES
(1, 1, '主导航', '主导航'),
(2, 0, '底部导航', '');
...
CREATE TABLE IF NOT EXISTS `dfer_nav_menu` (
...
--
-- 转存表中的数据 `dfer_nav_menu`
--

INSERT INTO `dfer_nav_menu` (`id`, `nav_id`, `parent_id`, `status`, `list_order`, `name`, `target`, `href`, `icon`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `dfer_option` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_plugin` (
...
--
-- 表的结构 `dfer_recycle_bin`
--

CREATE TABLE IF NOT EXISTS `dfer_recycle_bin` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_role` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dfer_role` (`id`, `parent_id`, `status`, `create_time`, `update_time`, `list_order`, `name`, `remark`) VALUES
...
CREATE TABLE IF NOT EXISTS `dfer_role_user` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_route` (
...
CREATE TABLE IF NOT EXISTS `dfer_slide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dfer_slide_item`
--

CREATE TABLE IF NOT EXISTS `dfer_slide_item` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_theme` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dfer_theme_file`
--

CREATE TABLE IF NOT EXISTS `dfer_theme_file` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dfer_third_party_user`
--

CREATE TABLE IF NOT EXISTS `dfer_third_party_user` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dfer_user` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `user_pass` varchar(64) NOT NULL DEFAULT '' COMMENT '登录密码;dfer_password加密',
...
--
-- 表的结构 `dfer_user_action`
--

CREATE TABLE IF NOT EXISTS `dfer_user_action` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `dfer_user_action`
--

INSERT INTO `dfer_user_action` VALUES ('1', '1', '1', '1', '2', '1', '用户登录', 'login', 'user', '');

-- --------------------------------------------------------

--
-- 表的结构 `dfer_user_action_log`
--

CREATE TABLE IF NOT EXISTS `dfer_user_action_log` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
...
--
-- 表的结构 `dfer_user_balance_log`
--

CREATE TABLE IF NOT EXISTS `dfer_user_balance_log` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dfer_user_favorite`
--

CREATE TABLE IF NOT EXISTS `dfer_user_favorite` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dfer_user_login_attempt`
--

CREATE TABLE IF NOT EXISTS `dfer_user_login_attempt` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `dfer_user_score_log`
--

CREATE TABLE IF NOT EXISTS `dfer_user_score_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '用户 id',
...
--
-- 表的结构 `dfer_user_token`
--

CREATE TABLE IF NOT EXISTS `dfer_user_token` (
...
--
-- 表的结构 `dfer_verification_code`
--

CREATE TABLE IF NOT EXISTS `dfer_verification_code` (
...
ALTER TABLE `dfer_auth_rule` CHANGE `app` `app` VARCHAR(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '规则所属app';

ALTER TABLE `dfer_user_favorite` ADD `thumbnail` VARCHAR(100) NOT NULL DEFAULT '' COMMENT '缩略图' AFTER `title`;

ALTER TABLE `dfer_user_favorite` CHANGE `url` `url` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收藏内容的原文地址，JSON格式';
ALTER TABLE `dfer_user_favorite` CHANGE `description` `description` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收藏内容的描述';
ALTER TABLE `dfer_user_favorite` CHANGE `table_name` `table_name` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '收藏实体以前所在表,不带前缀';


CREATE TABLE `dfer_user_like` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户 id',
...
ALTER TABLE `dfer_user` CHANGE `mobile` `mobile` VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '中国手机不带国家代码，国际手机号格式为：国家代码-手机号';
