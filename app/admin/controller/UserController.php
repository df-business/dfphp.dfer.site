...
class UserController extends AdminBaseController
{
        ...
        if ($this->request->isPost()) {
            ...
            if (!empty($roleIds) && is_array($roleIds)) {
                ...
                if ($result !== true) {
                    ...
                    $data['user_pass']       = dfer_password($data['user_pass']);
                    ...
                    if ($userId !== false) {
                        ...
                        foreach ($roleIds as $roleId) {
                            if (dfer_get_current_admin_id() != 1 && $roleId == 1) {
    ...
    public function userInfoPost()
    {
        if ($this->request->isPost()) {
            ...
            $data['id']       = dfer_get_current_admin_id();
    ...
    public function emailSetting()
    {
        ...
        $emailSetting = dfer_get_option('admin_smtp_setting_' . $adminId);
    ...
    public function emailSettingPost()
    {
        if ($this->request->isPost()) {
            ...
            $adminId = dfer_get_current_admin_id();
            dfer_set_option('admin_smtp_setting_' . $adminId, $post);
