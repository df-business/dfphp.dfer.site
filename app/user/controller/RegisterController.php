...
//                'captcha'  => 'require',
            ...
            $isOpenRegistration = dfer_is_open_registration();
            ...
            if (!$isOpenRegistration) {
                ...
                $errMsg = dfer_check_verification_code($data['username'], $data['code']);
                if (!empty($errMsg)) {
                    $this->error($errMsg);
                }
            ...
            $redirect                = empty($sessionLoginHttpReferer) ? dfer_get_root() . '/' : $sessionLoginHttpReferer;
            switch ($log) {
                case 0:
