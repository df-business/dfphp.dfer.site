...
class PublicController extends RestBaseController
{
    ...
    public function login()
    {
        ...
        $code          = $data['code'];
        $wxappSettings = dfer_get_option('wxapp_settings');
        ...
        $response = dfer_curl_get("https://api.weixin.qq.com/sns/jscode2session?appid=$appId&secret=$appSecret&js_code=$code&grant_type=authorization_code");
        ...
        if ($findThirdPartyUser) {
            ...
            $token  = dfer_generate_user_token($findThirdPartyUser['user_id'], 'wxapp');
            ...
            $token = dfer_generate_user_token($userId, 'wxapp');
