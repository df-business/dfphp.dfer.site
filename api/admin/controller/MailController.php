...
class MailController extends RestAdminBaseController
{
    ...
    {
        $emailSetting = dfer_get_option('smtp_setting');
    ...
    public function configPut()
    {
        ...
        dfer_set_option('smtp_setting', $post);
    ...
    public function test()
    {
        if ($this->request->isPost()) {
            ...
            $result = dfer_send_email($data['to'], $data['subject'], $data['content']);
    ...
    public function template()
    {
        ...
        $template = dfer_get_option('email_template_' . $templateKey);
    ...
    public function templatePut()
    {
        if ($this->request->isPut()) {
            ...
            dfer_set_option('email_template_' . $templateKey, $data);
