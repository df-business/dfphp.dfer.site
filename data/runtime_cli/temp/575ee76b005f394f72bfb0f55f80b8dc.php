<?php /*a:2:{s:106:"F:\Users\dfer\Documents\dfer\Project\dfphp.dfer.site\\tp_public\themes/admin_default/admin\main\index.html";i:1716369056;s:103:"F:\Users\dfer\Documents\dfer\Project\dfphp.dfer.site\\tp_public\themes/admin_default/public\header.html";i:1716362061;}*/ ?>
<?php 
            ...
            <div class="panel-body home-info">
                <ul class="list-unstyled">
                    <li>
                        <em>完全开发手册</em>
                        <span>
                            <a class="label label-success" href="https://www.thinkcmf.com/docs/cmf8/"
                    ...
                    <li>
                        <em>API开发手册</em>
                        <span>
                            <a class="label label-success" href="https://www.thinkcmf.com/docs/cmf8/#/API"
                               target="_blank">立即阅读</a>
                        </span>
                    </li>
                </ul>
    ...
    <?php if(empty($has_smtp_setting) || (($has_smtp_setting instanceof \think\Collection || $has_smtp_setting instanceof \think\Paginator ) && $has_smtp_setting->isEmpty())): ?>
        <div class="grid-item col-md-12">
            <div class="alert alert-danger alert-dismissible fade in" role="alert"
                ...
                <button type="button" class="close cmf-alert-close" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                <strong><i class="fa fa-times-circle alert-icon"></i></strong> 邮箱配置未完成,无法进行邮件发送!
                <a href="javascript:" class="label label-success" data-dismiss="alert" aria-label="Close"
    ...
    <?php endif; if(!function_exists('finfo_open')): ?>
        <div class="grid-item col-md-12">
            <div class="alert alert-danger alert-dismissible fade in" role="alert" style="margin-bottom: 0;">
                ...
                <strong><i class="fa fa-times-circle alert-icon"></i></strong> php_fileinfo扩展没有开启，无法正常上传文件！
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        <button type="button" class="close cmf-alert-close pull-right" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </h3>
                </div>
...
<?php 
    $lang_set=dfer_current_lang();
    $thinkdfer_version=dfer_version();
 ?>
<script>
    ...
    Wind.use('masonry', 'imagesloaded', 'dragula', function () {
        ...
        $.ajax({
            url: "https://www.thinkcmf.com/service/team.php?lang=<?php echo $lang_set; ?>&v=<?php echo $thinkdfer_version; ?>",
            type: 'get',
            dataType: 'json',
    ...
    //获取官方通知
    $.getJSON("https://www.thinkcmf.com/service/sms_jsonp.php?lang=<?php echo $lang_set; ?>&v=<?php echo $thinkdfer_version; ?>&callback=?",
        function (data) {
