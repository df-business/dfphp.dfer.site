<?php /*a:2:{s:108:"F:\Users\dfer\Documents\dfer\Project\dfphp.dfer.site\\tp_public\themes/admin_default/admin\setting\site.html";i:1716360124;s:103:"F:\Users\dfer\Documents\dfer\Project\dfphp.dfer.site\\tp_public\themes/admin_default/public\header.html";i:1716362061;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-10">
                                ...
                                <?php 
                                    ...
                                    $site_domain = dfer_get_domain().$root;
                                 ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-10">
                                <?php 
                                    $site_admin_style=empty($admin_settings['admin_style'])?dfer_get_admin_style('arcoadmin'):$admin_settings['admin_style'];
                                 ?>
                        ...
                        <?php if(APP_DEBUG && false): ?>
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-10">
                                    <?php 
                                        $site_default_app=empty($dfer_settings['default_app'])?'demo':$dfer_settings['default_app'];
                                     ?>
                                    <select class="form-control" name="dfer_settings[default_app]"
                    ...
                    <div class="tab-pane" id="F">
                        <div class="form-group">
                            <label for="input-banned_usernames" class="col-sm-2 control-label"><?php echo lang('User Register Verify'); ?></label>
                            <div class="col-md-8 col-sm-10">
                                <select class="form-control" name="dfer_settings[open_registration]">
                                    <option value="0"><?php echo lang('YES'); ?></option>
                                    <?php 
                                        $open_registration_selected = empty($dfer_settings['open_registration'])?'':'selected';
                                     ?>
                        ...
                        <div class="form-group" style="display: none;">
                            ...
                            <div class="col-md-8 col-sm-10">
                                <textarea class="form-control" id="input-banned_usernames"
                                          name="dfer_settings[banned_usernames]"><?php echo (isset($dfer_settings['banned_usernames']) && ($dfer_settings['banned_usernames'] !== '')?$dfer_settings['banned_usernames']:''); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <div class="tab-pane" id="G">
                        <div class="form-group">
                            <label for="input-cdn_static_root" class="col-sm-2 control-label"><?php echo lang('CDN Root'); ?></label>
                            <div class="col-md-8 col-sm-10">
