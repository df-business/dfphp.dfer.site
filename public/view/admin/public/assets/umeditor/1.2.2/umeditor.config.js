...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        UMEDITOR_HOME_URL : "https://oss.dfer.site/umeditor/1.2.2/"

        //图片上传配置区
        ,imageUrl:"http://dfphp.dfer.site.local/admin/upload/umeditor_upload"              //图片上传提交地址
        ...
        ,textarea:'data[content]' // 提交表单时，服务器获取编辑器提交内容的所用的参数，多实例时可以给容器name属性，会将name给定的值最为每个实例的键值，不用每次实例化的时候都设置这个值
